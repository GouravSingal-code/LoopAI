...
def weekly_task(last_week_start_date , last_week_end_date):
    ...
    '''
    rows = db_connection.execute_query(get_data, (last_week_start_date, last_week_end_date, env.STEP_INTERPOLATION_VALUE, last_week_start_date, last_week_end_date, env.STEP_INTERPOLATION_VALUE))
    for row in rows:
